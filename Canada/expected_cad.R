...
lifeTable_avg <- read.xls("Data/mortality_cad_avg.xlsx")
lifeTable_2015 <- read.xls("Data/mortality_cad_2015.xlsx")
lifeTable_2019 <- read.xls("Data/mortality_cad_2019.xlsx")
...
write.table(file = "Data/Data_Canada_avg",data_x_new)
...
#produce data file with expected mortality (will be used for plotting)
write.table(file = "Data/Data_Canada_2015",data_x_new)
...
#produce data file with expected mortality (will be used for plotting)
write.table(file = "Data/Data_Canada_2019",data_x_new)
