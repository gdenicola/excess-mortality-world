...
lifeTable_avg <- read.xls("Data/mortality_aut_avg.xlsx")
lifeTable_2015 <- read.xls("Data/mortality_aut_2015.xlsx")
lifeTable_2019 <- read.xls("Data/mortality_aut_2019.xlsx")
...
write.table(file = "Data/Data_Austria_avg",data_x_new)
...
#produce data file with expected mortality (will be used for plotting)
write.table(file = "Data/Data_Austria_2015",data_x_new)
...
#produce data file with expected mortality (will be used for plotting)
write.table(file = "Data/Data_Austria_2019",data_x_new)
