...
exp.USA.avg <- read.table("Data/Data_USA_3y")
...
df_all_ungrouped <- cbind.data.frame(Year,Deaths = exp.USA.avg.grouped$`sum(expected)`
            )
...
ggsave("USA_3y.png",width = 10,height = 7)
